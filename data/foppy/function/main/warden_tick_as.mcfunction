...
execute at @s[tag = charging] if entity @e[type=!item,tag=!warden,type=!marker,type=!armor_stand,type=!item,distance=..2] run function foppy:attacks/void_charge/end