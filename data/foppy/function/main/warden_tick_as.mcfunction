...
execute at @s[tag = charging] if entity @e[type=!#foppy:unalive,tag=!warden,distance=..2] run function foppy:attacks/void_charge/end
execute at @s[tag = charging] positioned ~ ~-1 ~ run function foppy:passives/sculk_spread_tiny
