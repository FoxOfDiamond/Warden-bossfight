...
execute positioned ~ ~ ~1 if block ~ ~ ~ sculk unless entity @e[type=marker,tag=warden_spread_marker,distance=..0.1] run summon marker ~ ~ ~ {Tags:["warden_spread_setup","warden_spread","warden_spread_marker"]}
execute positioned ~ ~ ~-1 if block ~ ~ ~ sculk unless entity @e[type=marker,tag=warden_spread_marker,distance=..0.1] run summon marker ~ ~ ~ {Tags:["warden_spread_setup","warden_spread","warden_spread_marker"]}
execute positioned ~1 ~ ~ if block ~ ~ ~ sculk unless entity @e[type=marker,tag=warden_spread_marker,distance=..0.1] run summon marker ~ ~ ~ {Tags:["warden_spread_setup","warden_spread","warden_spread_marker"]}
execute positioned ~-1 ~ ~ if block ~ ~ ~ sculk unless entity @e[type=marker,tag=warden_spread_marker,distance=..0.1] run summon marker ~ ~ ~ {Tags:["warden_spread_setup","warden_spread","warden_spread_marker"]}
